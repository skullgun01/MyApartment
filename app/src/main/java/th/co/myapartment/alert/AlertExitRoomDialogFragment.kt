package th.co.myapartment.alert
...
import th.co.myapartment.databinding.LayoutAlertExitRoomDialogBinding

class AlertExitRoomDialogFragment : DialogFragment() {

    lateinit var binding: LayoutAlertExitRoomDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = LayoutAlertExitRoomDialogBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    class Builder {
        ...
        fun build(): AlertExitRoomDialogFragment {
    ...
    companion object {
        ...
        fun newInstance(text: String, callback: (() -> Unit)?): AlertExitRoomDialogFragment {
            val fragment = AlertExitRoomDialogFragment()
            val bundle = Bundle()
